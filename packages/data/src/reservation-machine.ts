...
export const TRANSITIONS: TransitionSpec[] = [
  ...
  { event: 'partner.cancel', pre: { kind: ['online'], pay: ['complete'] }, when: ['refundedAt'], post: { pay: 'refunded', kept: true }, effects: ['dayRow'] },
  { event: 'partner.cancel', pre: { kind: ['online'], pay: ['complete'] }, post: { pay: 'canceled', kept: true }, effects: ['dayRow'] },
