    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 rounded-full mb-6">
          ...
          <span className="text-xs font-medium text-emerald-700">Now accepting partners</span>
        </div>
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight leading-tight max-w-3xl mx-auto">
          Manage your beach business,{' '}
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold text-gray-900">Everything you need to run your venue</h2>
          <p className="mt-2 text-sm text-gray-500">From sunbed inventory to payment settlement</p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Drag-and-drop sunbed layout with satellite map overlay. Configure parcels, rows, and pairing.',
            },
            {
              icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              desc: 'See bookings per hour and per day. Never oversell — availability updates in real time.',
            },
            {
              icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              desc: 'Accept card payments via Stripe. Automated invoicing, VAT handling, and transparent settlements.',
            },
            {
              icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              title: 'Mobile QR passes',
              desc: 'Guests get a QR pass after booking. Staff scan to validate — no paper tickets needed.',
            },
            {
              icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              title: 'On-site orders',
              desc: 'Sell food, drinks, and accessories. Guests order from their phone, you fulfill from the bar.',
            },
            {
              icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              desc: 'Generate time-limited access tokens for on-site staff. Control who sees what, and when.',
            },
          ].map((f) => (
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-sm text-gray-500">Start free. Upgrade when you grow.</p>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 text-center">
        <div className="bg-gray-900 rounded-2xl p-10 md:p-14">
          <h2 className="text-2xl md:text-3xl font-bold text-white">
            Ready to modernize your beach business?
          </h2>
          <p className="mt-3 text-gray-400 max-w-xl mx-auto">
            Join venues across the Mediterranean already using Sunbnb to manage reservations,
