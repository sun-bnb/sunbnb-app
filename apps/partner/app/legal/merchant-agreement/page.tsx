      ...
      <div className="max-w-3xl mx-auto px-6 py-12 text-sm text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          ...
          <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <ol className="list-decimal list-inside text-gray-600 space-y-2">
              ...
              <li>
                Mollie automatically deducts the <strong>platform service fee</strong> (the &ldquo;Application Fee&rdquo;) from the transaction amount and routes it to {co.companyName}&rsquo;s platform account.
              </li>
              <li>
          ...
          <p className="mt-3">
            {co.companyName} does not hold, pool, or intermediate customer funds at any point. All funds flow through the regulated Mollie payment infrastructure.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="mt-2 list-disc list-inside text-gray-600 space-y-1.5">
            ...
            <li>{co.companyName} does not act as a reseller, agent, or commissionaire for tax purposes.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Settlements from Mollie to the Merchant follow Mollie&rsquo;s standard settlement cycle (typically T+1 to T+2 business days for established accounts). {co.companyName} provides itemised settlement reports within the partner dashboard, including gross revenue, platform fees, Mollie transaction fees, refunds, and net payouts.
          </p>
        </section>
        ...
        <section className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-5">
          ...
          <p className="text-gray-700">
            In compliance with <strong>Regulation (EU) 2019/1150</strong> (Platform-to-Business Regulation), {co.companyName} discloses the following:
          </p>
