  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-lg font-semibold text-gray-900">Access Keys</h1>
          <p className="text-sm text-gray-500 mt-0.5">
            {tokens.length} {tokens.length === 1 ? 'access key' : 'access keys'} · {activeTokens.length} active
          </p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Create access key</h2>
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 mb-1.5">Resources</label>
              <input
                type="text"
                value={resources}
                ...
                placeholder="e.g. all, manage_site"
                required
              />
              <p className="text-[11px] text-gray-400 mt-1">Comma-separated list of permissions</p>
            </div>
      ...
      {createdToken && (
        <div className="mb-6 bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium text-emerald-800">Access key created</p>
      ...
      {tokens.length > 0 ? (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left text-[11px] font-medium text-gray-400 uppercase tracking-wider px-5 py-3">Access Key</th>
                <th className="text-left text-[11px] font-medium text-gray-400 uppercase tracking-wider px-5 py-3">Resources</th>
                <th className="text-left text-[11px] font-medium text-gray-400 uppercase tracking-wider px-5 py-3">Expires</th>
        ...
        <div className="text-center py-16 border border-dashed border-gray-300 rounded-xl">
          ...
          <p className="text-sm text-gray-500 mb-4">No access keys yet</p>
          <button
