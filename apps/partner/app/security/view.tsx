    ...
    <div className="container mx-auto px-4 py-6 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            {tokens.length} {tokens.length === 1 ? 'token' : 'tokens'} · {activeTokens.length} active
          </p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Create token</h2>
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-[11px] text-gray-400 mt-1">Comma-separated list of resource scopes</p>
            </div>
      ...
      {tokens.length > 0 ? (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left text-[11px] font-medium text-gray-400 uppercase tracking-wider px-5 py-3">Token</th>
        ...
        <div className="text-center py-16 border border-dashed border-gray-300 rounded-xl">
          ...
          <p className="text-sm text-gray-500 mb-4">No API tokens yet</p>
          <button
