...
const DEFERRED: Record<string, string> = {
  ...
  'collect.start': 'machine-level integration coverage in @repo/data (demo + provider-failure revert); driving the ACTION needs DEMO_MODE at module load',
  'pay.confirm': 'executor live (invoiceOnline); webhook/poll drivers migrate with the user-app slice (f)',
  'pay.fail': 'machine-level integration coverage in @repo/data (collecting → unsettled revert)',
  'collect.abandon': 'machine-level integration coverage in @repo/data (paid-race → pay.confirm; revert-never-delete)',
