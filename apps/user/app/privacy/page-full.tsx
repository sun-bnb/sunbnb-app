    ...
    <div className="max-w-3xl mx-auto px-6 py-12 text-sm text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <ul className="mt-2 list-disc list-inside text-gray-600 space-y-1">
          ...
          <li><strong>Marketing Preferences:</strong> Opt-ins and preferences for receiving marketing communications.</li>
        </ul>
        ...
        <div className="mt-2 bg-gray-50 border border-gray-200 rounded-lg p-4">
          <table className="w-full text-sm">
            ...
            <tbody className="text-gray-600">
              ...
              <tr className="border-b border-gray-100"><td className="py-1.5">To improve our services</td><td className="py-1.5">Legitimate interest</td></tr>
              <tr><td className="py-1.5">To send marketing communications</td><td className="py-1.5">Consent (where required)</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="mt-2 list-disc list-inside text-gray-600 space-y-1">
          ...
          <li><strong>Affiliates or Partners:</strong> For business purposes, in compliance with GDPR.</li>
        </ul>
