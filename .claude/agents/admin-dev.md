...
5. **UI work:** if the task touches UI, run `/ui admin` first — it loads the design language (`.claude/rules/ui.md` + `.claude/wiki/subsystems/design-system.md`) and the reference impl. Apply it; don't improvise styles.
