...
- [`flow:walk-in`](flows/walk-in.md) — **stable** — partner manage page: occupancy lifecycle (walk-in/hold/comp/block creators vs transitions), `[from,to]` + `until`, two-clock GC via cleanup cron, pool seats
