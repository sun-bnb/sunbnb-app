...
| [004](004-partner-test-architecture.md) | Partner Test Architecture | **Phase 3 done — FULL GATE GREEN, promote unblocked** (spine + all reds fixed + bug #2 cross-app + 21 user-app fixture gaps). Backlog: Phase 1 backfill, Phase 4 ratchet/extraction. Commits → `b803462`. | — | 2026-06-16 |
